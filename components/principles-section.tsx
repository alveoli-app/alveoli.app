  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "THE ORIGIN", highlight: true },
        { text: " STORY", highlight: false },
      ],
      description:
        "Alveoli was born from the frustration of disconnected development workflows and the need to bridge the gap between market signals and engineering execution.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "FROM INTERNAL", highlight: false },
        { text: " TOOL TO PLATFORM", highlight: true },
      ],
      description:
        "What started as a way to correlate customer feedback with development priorities has evolved into a comprehensive platform that auto-generates ranked backlogs and sprint plans.",
      align: "right",
    },
    {
      number: "03",
      ...
      description:
        "GitMesh CE is developed in the open under LFDT governance, ensuring transparency and community collaboration.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "BUILT BY", highlight: false },
        { text: " DEVELOPERS", highlight: true },
      ],
      description:
        "Every feature comes from real-world needs and community feedback. Enterprise Edition is built, hosted, and supported by Alveoli.",
      align: "right",
    },
  ]
