    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Navigate</h4>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="https://github.com/alveoli-app"
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/company/alveoli-app"
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:support@alveoli.app"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
                Email
              </a>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 Alveoli. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">GitMesh Enterprise Edition</p>
      </div>
    </section>
  )
}
