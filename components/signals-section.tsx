...
const signals = [
  {
    date: "2025.12.31",
    title: "Alveoli v1.0 Launched",
    note: "Alveoli platform officially released.",
  },
  {
    date: "2025.12.15",
    title: "120+ GitHub Stars",
    note: "GitMesh CE reaches 120+ stars on GitHub from the community.",
  },
  {
    date: "2025.11.20",
    title: "LFDT Governance",
    note: "GitMesh CE joins Linux Foundation Decentralized Trust Lab.",
  },
  {
    date: "2025.10.30",
    title: "OpenSSF Silver Badge",
    note: "Achieved OpenSSF Silver Badge for Best Practices.",
  },
  {
    date: "2025.09.15",
    title: "Open Source Friday",
    note: "GitMesh CE invited to GitHub's Open Source Friday 2026.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">UPDATES</h2>
      </div>
